...
function Footer() {
  ...
  return (
    <footer className="bg-[#FFF7F5] text-gray-800 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            */}
            ...
            <p className="text-sm text-gray-600">KITS THAT CARE</p>
          </div>
          ...
          <div>
            ...
            <form>
              <input
                ...
                className="w-full px-4 py-3 mb-3 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-300"
              />
              <button
                type="submit"
                className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg shadow-sm font-semibold text-gray-800 hover:bg-gray-50 transition-colors duration-300"
              >
                SIGN UP
              </button>
            </form>
        ...
        <div className="mt-16 pt-8 border-t border-gray-300 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2">
            ...
            {[
              ...
              return link ? (
                <a key={name} href={link.href} className="hover:text-gray-800">
                  {link.name}
                </a>
              ) : null;
            })}
