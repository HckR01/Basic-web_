          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-6">
              <Link to="/" className="flex items-center gap-3">
                <div className="h-10 w-10 bg-blue-600 text-white rounded flex items-center justify-center font-bold">
                  OG
                </div>
                <span className="font-semibold text-lg text-gray-800">
                  Online<span className="text-blue-600">GetPrep</span>
                </span>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-4 flex-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
            ...
            <section className="order-1 lg:order-2 text-center lg:text-right px-2 lg:px-0 py-12 lg:py-0">
              ...
              <p className="text-gray-600 mb-8 hidden sm:block">
      ...
      >
        ...
        <div className="w-full min-h-[calc(100vh-64px)] max-w-7xl mx-auto px-4 sm:px-4 lg:px-4 py-12 flex flex-col">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 flex-1 items-start">
            {/* Card 1 */}
            <div className="bg-white rounded-xl p-6 transform transition duration-300 hover:-translate-y-3 hover:scale-105 hover:shadow-2xl cursor-pointer">
