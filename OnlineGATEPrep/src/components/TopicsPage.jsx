...
function TopicsPage() {
  ...
  return (
    <div className="min-h-screen pt-24 bg-gray-900 text-white relative overflow-hidden">
      {/* animated background (subtle, dark-themed) */}
      <div
        aria-hidden
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {topics.map((topic) => {
            ...
            return (
              <Link
                key={topic.id}
                to={`/test/${topic.id}`} // <-- now goes to TestPage
              ...
              >
                {/* decorative blurred blob behind each card */}
                <div
                  aria-hidden
